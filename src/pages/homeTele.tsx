            ...
            {isActive ? <> 
                ...
                <div className='my-5 justify-between flex w-full'>
                    ...
                    {!isHistory && <div className='flex flex-row'>
                        <a className="p-3 border-2 rounded-lg bg-blue-200 hover:bg-blue-400 cursor-pointer border-black mr-2 text-black" href='https://res.cloudinary.com/dfs1kb2dk/raw/upload/v1688610373/telegram_xcel/import_file_error_cikx57.csv'>
                            Lấy file mẫu
                        </a>
